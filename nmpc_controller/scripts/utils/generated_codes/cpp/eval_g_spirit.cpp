...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw,
  ...
  a5 = 1.9058754365217390e-01;
  a4 = arg[0] ? arg[0][9] : 0;
  a4 = (a6 - a4);
  a5 = (a5 * a4);
  a21 = 5.6778847999999993e-02;
  a24 = (a12 * a10);
  a21 = (a21 * a24);
  a24 = arg[1] ? arg[1][2] : 0;
  a25 = (a24 * a13);
  ...
  a25 = (a12 - a25);
  a21 = (a21 * a25);
  a38 = -6.2715975058434781e-01;
  a38 = (a38 * a0);
  a39 = arg[0] ? arg[0][11] : 0;
  a39 = (a10 - a39);
  a38 = (a38 * a39);
  a21 = (a21 + a38);
  a38 = -1.1102230246251570e-16;
  a40 = 3932292856920107.;
  a41 = (a10 * a11);
  a40 = (a40 * a41);
  a41 = 3420874459529455.;
  a42 = (a12 * a0);
  a41 = (a41 * a42);
  a40 = (a40 + a41);
  a40 = (a6 * a40);
  ...
  a5 = (a5 * a25);
  a21 = (a21 + a5);
  a5 = 6.2715975058434781e-01;
  a25 = (a11 * a8);
  a5 = (a5 * a25);
  a5 = (a5 * a39);
  a21 = (a21 + a5);
  a5 = -5.6778847999999993e-02;
  a39 = (a12 * a10);
  a39 = (a39 * a13);
  a5 = (a5 * a39);
  a39 = 3.7979335893217392e-01;
  a12 = (a6 * a12);
  a12 = (a12 * a11);
  a12 = (a12 * a8);
  a39 = (a39 * a12);
  a5 = (a5 + a39);
  a39 = 4.3657220693217391e-01;
  a6 = (a6 * a10);
  a6 = (a6 * a8);
  a6 = (a6 * a0);
  a39 = (a39 * a6);
...
extern "C" CASADI_SYMBOL_EXPORT int eval_g_spirit(const casadi_real** arg,
                                                  casadi_real** res,
                                                  casadi_int* iw,
                                                  casadi_real* w, int mem) {
...
extern "C" CASADI_SYMBOL_EXPORT int eval_g_spirit_alloc_mem(void) { return 0; }
...
extern "C" CASADI_SYMBOL_EXPORT int eval_g_spirit_checkout(void) { return 0; }
...
extern "C" CASADI_SYMBOL_EXPORT casadi_int eval_g_spirit_n_in(void) {
  return 2;
}

extern "C" CASADI_SYMBOL_EXPORT casadi_int eval_g_spirit_n_out(void) {
  return 1;
}

extern "C" CASADI_SYMBOL_EXPORT casadi_real
eval_g_spirit_default_in(casadi_int i) {
  switch (i) {
    default:
      return 0;
  }
...
extern "C" CASADI_SYMBOL_EXPORT const char* eval_g_spirit_name_in(
    casadi_int i) {
  switch (i) {
    case 0:
      return "w";
...
extern "C" CASADI_SYMBOL_EXPORT const char* eval_g_spirit_name_out(
    casadi_int i) {
  switch (i) {
    case 0:
      return "g";
...
extern "C" CASADI_SYMBOL_EXPORT const casadi_int* eval_g_spirit_sparsity_in(
    casadi_int i) {
  switch (i) {
    case 0:
      return casadi_s0;
...
extern "C" CASADI_SYMBOL_EXPORT const casadi_int* eval_g_spirit_sparsity_out(
    casadi_int i) {
  switch (i) {
    case 0:
      return casadi_s2;
...
extern "C" CASADI_SYMBOL_EXPORT int eval_g_spirit_work(casadi_int* sz_arg,
                                                       casadi_int* sz_res,
                                                       casadi_int* sz_iw,
                                                       casadi_int* sz_w) {
  if (sz_arg) *sz_arg = 2;
