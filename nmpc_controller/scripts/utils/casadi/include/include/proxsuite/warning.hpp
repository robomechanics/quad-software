 ...
 * Please see
 * https://github.com/jrl-umi3218/jrl-cmakemodules/blob/master/warning.hh.cmake
 * for details.
 */
...
#define PROXSUITE_WARN_STRINGISE(x) PROXSUITE_WARN_STRINGISE_IMPL(x)
#ifdef __GNUC__
#define PROXSUITE_WARN(exp) ("WARNING: " exp)
#else
#ifdef _MSC_VER
#define FILE_LINE_LINK __FILE__ "(" PROXSUITE_WARN_STRINGISE(__LINE__) ") : "
