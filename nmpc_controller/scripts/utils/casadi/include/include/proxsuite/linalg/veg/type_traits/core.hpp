...
#if defined(VEG_WITH_CXX20_SUPPORT)
VEG_DEF_CONCEPT((template <typename...> class Op, typename... Args), detected,
...
VEG_DEF_CONCEPT(typename T, const_type,
                VEG_HAS_BUILTIN_OR(__is_const, __is_const(T),
                                   (_detail::_meta::is_const<T>::value)));
VEG_DEF_CONCEPT(typename T, void_type,
...
VEG_DEF_CONCEPT(typename T, reference,
