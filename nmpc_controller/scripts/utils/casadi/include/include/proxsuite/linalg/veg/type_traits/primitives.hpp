...
VEG_DEF_CONCEPT(typename T, enum_type,
                VEG_HAS_BUILTIN_OR(__is_enum, __is_enum(T),
                                   std::is_enum<T>::value));
VEG_DEF_CONCEPT_FROM_BUILTIN_OR_STD(typename T, integral, T);
VEG_DEF_CONCEPT_FROM_BUILTIN_OR_STD(typename T, floating_point, T);
VEG_DEF_CONCEPT_DISJUNCTION(typename T, arithmetic,
                            ((, integral<T>), (, floating_point<T>)));
VEG_DEF_CONCEPT_CONJUNCTION(typename T, signed_integral,
                            ((, integral<T>), (aux::, no_wraps_around<T>)));
VEG_DEF_CONCEPT_CONJUNCTION(typename T, unsigned_integral,
