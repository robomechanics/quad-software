...
struct Slice : _detail::_slice::adl::AdlBase {
 ...
 public:
  ...
  VEG_INLINE
  constexpr Slice(Unsafe /*tag*/, FromRawParts /*tag*/, T const* data_,
                  isize count) VEG_NOEXCEPT : data{data_},
                                              size{count} {}
...
struct SliceMut : private Slice<T> {
  ...
  VEG_INLINE
  constexpr SliceMut(Unsafe /*tag*/, FromRawParts /*tag*/, T const* data_,
                     isize count) VEG_NOEXCEPT : Slice<T>{
                                                     unsafe,
                                                     from_raw_parts,
                                                     data_,
                                                     count,
