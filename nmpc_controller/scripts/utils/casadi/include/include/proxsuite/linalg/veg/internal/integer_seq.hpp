...
namespace concepts {
VEG_DEF_CONCEPT(typename... Ts, all_same,
                _detail::_meta::all_same_impl<
                    meta::make_index_sequence<sizeof...(Ts)>, Ts...>::value);
}  // namespace concepts
...
template <template <typename...> class F, typename... Ts, typename Seq,
          typename... Seqs>
...
using type_sequence_cat = typename _detail::_meta::concat_type_seq<
    bool_constant<VEG_ALL_OF(_detail::_meta::specializes<F, Seqs>::value)>, F,
    Seqs...>::type;
...
using type_sequence_zip = typename _detail::_meta::zip_type_seq<
    meta::bool_constant<
        ...
        VEG_CONCEPT(all_same<constant<usize, _detail::_meta::specialize_len<
                                                 F, Seqs>::value>...>)>,
    F, Seqs...>::type;
