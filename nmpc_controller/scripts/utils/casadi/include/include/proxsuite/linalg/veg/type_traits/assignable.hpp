...
VEG_DEF_CONCEPT_FROM_BUILTIN_OR_STD((typename T, typename U),
                                    nothrow_assignable, T&&, U&&);

VEG_DEF_CONCEPT_FROM_BUILTIN_OR_TRAIT(typename T, trivially_copy_assignable,
                                      is_trivially_assignable, T&, T const&);
VEG_DEF_CONCEPT_FROM_BUILTIN_OR_TRAIT(typename T, trivially_move_assignable,
                                      is_trivially_assignable, T&, T&&);

VEG_DEF_CONCEPT(typename T, move_assignable, VEG_CONCEPT(assignable<T&, T&&>));
VEG_DEF_CONCEPT(typename T, nothrow_move_assignable,
                VEG_CONCEPT(nothrow_assignable<T&, T&&>));

VEG_DEF_CONCEPT(typename T, copy_assignable,
                VEG_CONCEPT(assignable<T&, T const&>));
VEG_DEF_CONCEPT(typename T, nothrow_copy_assignable,
