 ...
 * Please see
 * https://github.com/jrl-umi3218/jrl-cmakemodules/blob/master/config.hh.cmake
 * for details.
 */
...
#define PROXSUITE_VERSION_UNKNOWN_TAG \
  0  // Used to mention that the current version is unknown.
