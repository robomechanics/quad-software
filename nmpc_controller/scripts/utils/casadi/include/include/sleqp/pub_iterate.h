 ...
 **/
SLEQP_EXPORT SLEQP_WARNUNUSED SLEQP_RETCODE sleqp_iterate_create(
    SleqpIterate** star, SleqpProblem* problem, const SleqpVec* x);

/**
 * The current point. Has dimension = num_variables.
 **/
SLEQP_EXPORT SleqpVec* sleqp_iterate_primal(const SleqpIterate* iterate);

/**
 * The current function value
 **/
SLEQP_EXPORT double sleqp_iterate_obj_val(const SleqpIterate* iterate);
 ...
 **/
SLEQP_EXPORT SleqpVec* sleqp_iterate_obj_grad(const SleqpIterate* iterate);

/**
 * The current constraint values. Has dimension = num_constraints.
 **/
SLEQP_EXPORT SleqpVec* sleqp_iterate_cons_val(const SleqpIterate* iterate);

/**
 * The Jacobian of the constraitns at the current iterate.
 * Has num_constraints many rows, num_variables many columns.
 */
SLEQP_EXPORT SleqpMat* sleqp_iterate_cons_jac(const SleqpIterate* iterate);

/**
 * The current working set.
 **/
SLEQP_EXPORT SleqpWorkingSet* sleqp_iterate_working_set(
    const SleqpIterate* iterate);

/**
 * The dual values of the constraints. Has dimension = num_constraints.
 */
SLEQP_EXPORT SleqpVec* sleqp_iterate_cons_dual(const SleqpIterate* iterate);

/**
 * The dual values of the variable bounds. Has dimension = num_variables.
 */
SLEQP_EXPORT SleqpVec* sleqp_iterate_vars_dual(const SleqpIterate* iterate);
