 ...
 **/
typedef void (*SLEQP_LOG_HANDLER)(SLEQP_LOG_LEVEL level, time_t time,
                                  const char* message);
...
SLEQP_EXPORT void sleqp_log_msg_level(int level, const char* fmt, ...)
    SLEQP_FORMAT_PRINTF(2, 3);

void sleqp_log_trace_level(int level, const char* file, int line,
                           const char* fmt, ...) SLEQP_FORMAT_PRINTF(4, 5);
