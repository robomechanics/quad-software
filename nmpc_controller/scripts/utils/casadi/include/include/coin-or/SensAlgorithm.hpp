...
class SIPOPTLIB_EXPORT SensAlgorithm : public AlgorithmStrategyObject {
 public:
  SensAlgorithm(std::vector<SmartPtr<SchurDriver> >& driver_vec,
                ...
                SmartPtr<Measurement> measurement, Index n_sens_steps);
 ...
 private:
  ...
  Index n_sens_steps_;  // I think it is useful to state this number explicitly
                        // in the constructor and here.
