...
class IPOPTLIB_EXPORT ZeroSymMatrix : public SymMatrix {
 ...
 protected:
  ...
  virtual void ComputeRowAMaxImpl(Vector& /*rows_norms*/, bool /*init*/
  ) const {}

  virtual void ComputeColAMaxImpl(Vector& /*cols_norms*/, bool /*init*/
  ) const {}
...
class IPOPTLIB_EXPORT ZeroSymMatrixSpace : public SymMatrixSpace {
 public:
  ...
  ZeroSymMatrixSpace(Index dim) : SymMatrixSpace(dim) {}

  /** Destructor */
  virtual ~ZeroSymMatrixSpace() {}
  ///@}

  virtual Matrix* MakeNew() const { return MakeNewZeroSymMatrix(); }

  virtual SymMatrix* MakeNewSymMatrix() const { return MakeNewZeroSymMatrix(); }
