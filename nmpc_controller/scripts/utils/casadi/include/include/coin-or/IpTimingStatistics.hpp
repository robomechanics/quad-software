...
class IPOPTLIB_EXPORT TimingStatistics : public ReferencedObject {
 public:
  ...
  void PrintAllTimingStatistics(const Journalist& jnlst, EJournalLevel level,
                                EJournalCategory category) const;

  /**@name Accessor methods to all timed tasks. */
  ///@{
  TimedTask& OverallAlgorithm() { return OverallAlgorithm_; }

  /// @since 3.14.0
  const TimedTask& OverallAlgorithm() const { return OverallAlgorithm_; }

  TimedTask& PrintProblemStatistics() { return PrintProblemStatistics_; }

  TimedTask& InitializeIterates() { return InitializeIterates_; }

  TimedTask& UpdateHessian() { return UpdateHessian_; }

  TimedTask& OutputIteration() { return OutputIteration_; }

  TimedTask& UpdateBarrierParameter() { return UpdateBarrierParameter_; }

  TimedTask& ComputeSearchDirection() { return ComputeSearchDirection_; }

  TimedTask& ComputeAcceptableTrialPoint() {
    return ComputeAcceptableTrialPoint_;
  }

  TimedTask& AcceptTrialPoint() { return AcceptTrialPoint_; }

  TimedTask& CheckConvergence() { return CheckConvergence_; }

  TimedTask& PDSystemSolverTotal() { return PDSystemSolverTotal_; }

  TimedTask& PDSystemSolverSolveOnce() { return PDSystemSolverSolveOnce_; }

  TimedTask& ComputeResiduals() { return ComputeResiduals_; }

  TimedTask& StdAugSystemSolverMultiSolve() {
    return StdAugSystemSolverMultiSolve_;
  }

  TimedTask& LinearSystemScaling() { return LinearSystemScaling_; }

  TimedTask& LinearSystemSymbolicFactorization() {
    return LinearSystemSymbolicFactorization_;
  }

  TimedTask& LinearSystemFactorization() { return LinearSystemFactorization_; }
  ...
  TimedTask& QualityFunctionSearch() { return QualityFunctionSearch_; }

  TimedTask& TryCorrector() { return TryCorrector_; }

  TimedTask& Task1() { return Task1_; }

  TimedTask& Task2() { return Task2_; }

  TimedTask& Task3() { return Task3_; }

  TimedTask& Task4() { return Task4_; }

  TimedTask& Task5() { return Task5_; }

  TimedTask& Task6() { return Task6_; }

  /// @since 3.14.0
  TimedTask& f_eval_time() { return f_eval_time_; }

  /// @since 3.14.0
  TimedTask& grad_f_eval_time() { return grad_f_eval_time_; }

  /// @since 3.14.0
  TimedTask& c_eval_time() { return c_eval_time_; }

  /// @since 3.14.0
  TimedTask& jac_c_eval_time() { return jac_c_eval_time_; }

  /// @since 3.14.0
  TimedTask& d_eval_time() { return d_eval_time_; }

  /// @since 3.14.0
  TimedTask& jac_d_eval_time() { return jac_d_eval_time_; }

  /// @since 3.14.0
  TimedTask& h_eval_time() { return h_eval_time_; }
  ///@}
