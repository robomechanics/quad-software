...
SIPOPTLIB_EXPORT SolverReturn
AppReturn2SolverReturn(ApplicationReturnStatus ipopt_retval);
}  // namespace Ipopt

// same as DECLARE_STD_EXCEPTION, but using SIPOPTLIB_EXPORT instead of
// IPOPTLIB_EXPORT
