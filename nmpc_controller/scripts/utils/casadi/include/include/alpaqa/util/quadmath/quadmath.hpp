...
inline __float128 copysign(__float128 x, __float128 y) {
...
inline __float128 fma(__float128 x, __float128 y, __float128 z) {
  return ::fmaq(x, y, z);
}
...
inline __float128 nextafter(__float128 x, __float128 y) {
  return ::nextafterq(x, y);
}
inline __float128 pow(__float128 x, __float128 y) { return ::powq(x, y); }
inline __float128 remainder(__float128 x, __float128 y) {
  return ::remainderq(x, y);
}
inline __float128 remquo(__float128 x, __float128 y, int *z) {
  return ::remquoq(x, y, z);
}
...
inline void sincosq(__float128 x, __float128 *y, __float128 *z) {
  return ::sincosq(x, y, z);
}
