...
ALPAQA_EXPORT std::string float_to_str(
    F value, int precision = std::numeric_limits<F>::max_digits10);

template <class T>
ALPAQA_EXPORT std::ostream &print_csv_impl(std::ostream &os, const T &M,
                                           std::string_view sep = ",",
