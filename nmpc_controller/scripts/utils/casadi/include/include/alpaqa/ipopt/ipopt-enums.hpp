...
inline std::string_view enum_name(Ipopt::ApplicationReturnStatus s) {
  ...
  switch (s) {
    case S::Solve_Succeeded:
      return "Solve_Succeeded";
    case S::Solved_To_Acceptable_Level:
