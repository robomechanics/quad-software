...
class OsiColCut : public OsiCut {
 ...
 public:
  ...
  inline void setLbs(int nElements, const int *colIndices,
  ...
  inline void setUbs(int nElements, const int *colIndices,
...
//-------------------------------------------------------------------
void OsiColCut::setLbs(int size, const int *colIndices,
                       const double *lbElements) {
  lbs_.setVector(size, colIndices, lbElements);
}
//
void OsiColCut::setUbs(int size, const int *colIndices,
                       const double *ubElements) {
  ubs_.setVector(size, colIndices, ubElements);
}
//
void OsiColCut::setLbs(const CoinPackedVector &lbs) { lbs_ = lbs; }
//
void OsiColCut::setUbs(const CoinPackedVector &ubs) { ubs_ = ubs; }

//-------------------------------------------------------------------
// Get Column Lower Bounds and Column Upper Bounds
//-------------------------------------------------------------------
const CoinPackedVector &OsiColCut::lbs() const { return lbs_; }
//
const CoinPackedVector &OsiColCut::ubs() const { return ubs_; }
...
bool OsiColCut::operator==(const OsiColCut &rhs) const {
  ...
  if (lbs() != rhs.lbs()) return false;
  if (ubs() != rhs.ubs()) return false;
  return true;
}
//
bool OsiColCut::operator!=(const OsiColCut &rhs) const {
