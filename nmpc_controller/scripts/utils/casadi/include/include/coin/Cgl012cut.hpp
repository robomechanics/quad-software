...
class Cgl012Cut {
 public:
  ...
  void alloc_parity_ilp(int mr, /* number of rows in the ILP matrix */
                        int mc, /* number of columns in the ILP matrix */
                        int mnz /* number of nonzero's in the ILP matrix */
  );
 ...
 private:
  ...
  int best_weakening(
      ...
      short int
          original_parity,     /* original parity of the constraint to weaken */
      ...
      info_weak **info_even_weak, /* weakening information about the best
                                     possible even weakened constraint */
      info_weak **info_odd_weak,  /* weakening information about the best
                                     possible  odd weakened constraint */
      short int
          only_odd, /* flag which tells whether only an odd weakening is of
  ...
  short int best_cut(int *ccoef,        /* vector of the coefficients */
                     int *crhs,         /* pointer to rhs value */
                     double *violation, /* violation of the cut */
                     short int update, /* TRUE/FALSE: if TRUE, the new ccoef and
                                          crhs are given on output */
                     short int only_viol /* flag which tells whether only an
                          inequality of slack smaller than MAX_SLACK is of
                          interest (TRUE) otherwise (FALSE) */
  );
  ...
  void modify_current(int i,          /* constraint to be moved */
                      short int itype /* type of move - ADD or DEL */
  );
  ...
  short int best_neighbour(
      cut_list *out_cuts /* list of the violated cuts found */);
  ...
  void restart(
      short int
          failure /* flag forcing the restart if some trouble occurred */);
  ...
  cut *define_cut(int *ccoef, /* coefficients of the cut */
                  int crhs    /* right hand side of the cut */
  );

  /* cut_score: define the score of a (violated) cut */

  double cut_score(int *ccoef,         /* cut left hand side coefficients */
                   int crhs,           /* cut right hand side */
