...
class HeuristicFPump : public CbcHeuristic {
 public:
  ...
  /** Virtual constructor.*/
  virtual CbcHeuristic *clone() const { return new HeuristicFPump(*this); }

  /// Resets stuff if model changes
  virtual void resetModel(CbcModel *model) { setModel(model); }
...
class RoundingFPump {
 public:
  ...
  /// Rounds the solution
  void round(const double integerTolerance, const double primalTolerance,
             double *solution);
