...
class StrongBranchingSolver : public Ipopt::ReferencedObject {
 public:
  ...
  virtual TNLPSolver::ReturnStatus solveFromHotStart(
      OsiTMINLPInterface* tminlp_interface) = 0;

  /// Called after all strong branching solves in a node
  virtual void unmarkHotStart(OsiTMINLPInterface* tminlp_interface) = 0;

 protected:
  inline Ipopt::SmartPtr<Ipopt::Journalist>& Jnlst() { return jnlst_; }
  inline Ipopt::SmartPtr<Ipopt::OptionsList>& Options() { return options_; }
