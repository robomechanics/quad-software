...
class CglRedSplit2Param : public CglParam {
 public:
  ...
  /// get the value
  inline std::vector<int> getNumRowsReduction() const {
    return numRowsReduction_;
  }
  /// reset
  ...
  /// get the value
  inline std::vector<ColumnSelectionStrategy> getColumnSelectionStrategy()
      const {
    return columnSelectionStrategy_;
  }
  /// reset
  inline void resetColumnSelectionStrategy() {
    columnSelectionStrategy_.clear();
  }
  ...
  /// get the value
  inline std::vector<RowSelectionStrategy> getRowSelectionStrategy() const {
    return rowSelectionStrategy_;
  };
  /// reset
  ...
  /// get the value
  inline std::vector<int> getNumRowsReductionLAP() const {
    return numRowsReductionLAP_;
  }
  /// reset
  ...
  /// get the value
  inline std::vector<ColumnSelectionStrategy> getColumnSelectionStrategyLAP()
      const {
    return columnSelectionStrategyLAP_;
  }
  /// reset
  inline void resetColumnSelectionStrategyLAP() {
    columnSelectionStrategyLAP_.clear();
  }
  ...
  /// get the value
  inline std::vector<RowSelectionStrategy> getRowSelectionStrategyLAP() const {
    return rowSelectionStrategyLAP_;
  };
  /// reset
  inline void resetRowSelectionStrategyLAP() {
    rowSelectionStrategyLAP_.clear();
  }
  ...
  /// get the value
  inline ColumnScalingStrategy getColumnScalingStrategyLAP() const {
    return columnScalingStrategyLAP_;
  };

  /** Set the value for the bound in the column scaling factor */
  virtual void setColumnScalingBoundLAP(double value);
  /// get the value
  inline double getColumnScalingBoundLAP() const {
    return columnScalingBoundLAP_;
  };
  ...
  CglRedSplit2Param(bool use_default_strategies = true, double eps = 1e-12,
                    double eps_coeff = 1e-11, double eps_elim = 0.0,
                    double eps_relax_abs = 1e-11, double eps_relax_rel = 1e-13,
                    double max_dyn = 1e6, double min_viol = 1e-3,
                    int max_supp_abs = 1000, double max_supp_rel = 0.1,
                    int use_int_slacks = 0, double norm_zero = 1e-5,
                    double minNormReduction = 0.1, int maxSumMultipliers = 10,
                    double normalization = 0.0001, double away = 0.005,
                    double timeLimit = 60, int maxNumCuts = 10000,
                    int maxNumComputedCuts = 10000, int maxNonzeroesTab = 1000,
                    double columnScalingBoundLAP = 5.0, int skipGomory = 1);
  ...
  /// usage!).
  CglRedSplit2Param(const CglParam &source, bool use_default_strategies = true,
                    double eps_elim = 0.0, double eps_relax_abs = 1e-11,
                    double eps_relax_rel = 1e-13, double max_dyn = 1e6,
                    double min_viol = 1e-3, double max_supp_rel = 0.1,
                    int use_int_slacks = 0, double norm_zero = 1e-5,
                    double minNormReduction = 0.1, int maxSumMultipliers = 10,
                    double normalization = 0.0001, double away = 0.005,
                    double timeLimit = 60, int maxNumCuts = 10000,
