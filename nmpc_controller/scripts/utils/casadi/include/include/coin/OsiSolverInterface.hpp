...
class OsiSolverInterface {
  friend void OsiSolverInterfaceCommonUnitTest(
      const OsiSolverInterface *emptySi, const std::string &mpsDir,
 ...
 public:
  ...
  class ApplyCutsReturnCode {
   ...
   public:
    ...
    inline int getNumInconsistent() const { return intInconsistent_; }
    ...
    inline int getNumInfeasible() const { return infeasible_; }
    /// Number of redundant or ineffective cuts
    inline int getNumIneffective() const { return ineffective_; }
    /// Number of cuts applied
    inline int getNumApplied() const { return applied_; }
    //@}
  ...
  /**
       ...
       Returns number of feasible leaves.  Also sets number of solves done and
  ...
  virtual int solveBranches(int depth, const OsiSolverBranch *branch,
                            OsiSolverResult *result, int &numberSolves,
                            int &numberIterations, bool forceBranch = false);
#endif
  //@}
  ...
  */
  ...
  virtual bool setHintParam(OsiHintParam key, bool yesNo = true,
    ...
    if (strength == OsiForceDo)
      throw CoinError("OsiForceDo illegal", "setHintParam",
                      "OsiSolverInterface");
    return true;
  }
  ...
  */
  ...
  inline void setColumnType(int iColumn, char type) {
    if (!columnType_) getColType(true);
  ...
  */
  ...
  /*! \brief Generate a standard name of the form Rnnnnnnn or Cnnnnnnn
    ...
    */
  virtual std::string dfltRowColName(char rc, int ndx,
  ...
  virtual inline void setObjName(std::string name) { objName_ = name; }
  ...
  /*! \brief Set multiple row names
    ...
    */
  virtual void setRowNames(OsiNameVec &srcNames, int srcStart, int len,
                           int tgtStart);
  ...
  /*! \brief Set multiple column names
    ...
    */
  virtual void setColNames(OsiNameVec &srcNames, int srcStart, int len,
                           int tgtStart);
  ...
  */
  ...
  virtual void addCol(const CoinPackedVectorBase &vec, const double collb,
                      const double colub, const double obj) = 0;
  ...
  /*! \brief Add a named column (primal variable) to the problem.
    ...
    */
  virtual void addCol(const CoinPackedVectorBase &vec, const double collb,
                      const double colub, const double obj, std::string name);

  /** Add a column (primal variable) to the problem. */
  virtual void addCol(int numberElements, const int *rows,
  ...
  /*! \brief Add a named row (constraint) to the problem.
    ...
    */
  virtual void addRow(const CoinPackedVectorBase &vec, const double rowlb,
                      const double rowub, std::string name);

  /*! \brief Add a row (constraint) to the problem. */
  virtual void addRow(const CoinPackedVectorBase &vec, const char rowsen,
                      const double rowrhs, const double rowrng) = 0;
  ...
  /*! Add a row (constraint) to the problem.
    ...
    */
  virtual void addRow(int numberElements, const int *columns,
                      const double *element, const double rowlb,
                      const double rowub);
  ...
  /*! \brief Write the problem in MPS format to the specified file with
    ...
    */
  int writeMpsNative(const char *filename, const char **rowNames,
                     const char **columnNames, int formatType = 0,
                     int numberAcross = 2, double objSense = 0.0,
  ...
  */
  virtual void writeLp(const char *filename, const char *extension = "lp",
                       double epsilon = 1e-5, int numberAcross = 10,
                       int decimals = 9, double objSense = 0.0,
  ...
  */
  virtual void writeLp(FILE *fp, double epsilon = 1e-5, int numberAcross = 10,
  ...
  /** Write the problem into an Lp file. Parameters are similar to
      ...
      useRowNames is true. */
  int writeLpNative(const char *filename, char const *const *const rowNames,
                    char const *const *const columnNames,
                    const double epsilon = 1.0e-5, const int numberAcross = 10,
                    const int decimals = 5, const double objSense = 0.0,
  ...
  */
  int writeLpNative(FILE *fp, char const *const *const rowNames,
                    char const *const *const columnNames,
                    const double epsilon = 1.0e-5, const int numberAcross = 10,
                    const int decimals = 5, const double objSense = 0.0,
                    const bool useRowNames = true) const;
  ...
  */
  ...
  /** Use current solution to set bounds so current integer feasible solution
     will stay feasible. Only feasible bounds will be used, even if current
     solution outside bounds.  The amount of such violation will be returned
     (and if small can be ignored)
    */
  ...
  */
  virtual void getReducedGradient(double *columnReducedCosts, double *duals,
  ...
  */
  virtual int primalPivotResult(int colIn, int sign, int &colOut,
                                int &outStatus, double &t,
                                CoinPackedVector *dx);
  ...
  /** Obtain a result of the dual pivot (similar to the previous method)
      ...
      Return code: same
  */
  virtual int dualPivotResult(int &colIn, int &sign, int colOut, int outStatus,
 ...
 protected:
  ...
  /** A quick inlined function to force a value to be between a minimum and
        a maximum value */
  template <class T>
  inline T forceIntoRange(const T value, const T lower, const T upper) const {
...
inline void OsiSolverInterface::convertBoundToSense(const double lower,
                                                    const double upper,
                                                    char &sense, double &right,
                                                    double &range) const {
...
inline void OsiSolverInterface::convertSenseToBound(const char sense,
                                                    const double right,
                                                    const double range,
                                                    double &lower,
                                                    double &upper) const {
