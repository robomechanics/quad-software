...
class ClpPlusMinusOneMatrix : public ClpMatrixBase {
 public:
  ...
  int *getMutableIndices() const { return indices_; }
  ...
  /// Just checks matrix valid - will say if dimensions not quite right if
  /// detail
  ...
  //@{
  /// Return starts of +1s
  inline CoinBigIndex *startPositive() const { return startPositive_; }
  /// Return starts of -1s
  inline CoinBigIndex *startNegative() const { return startNegative_; }
  //@}
  ...
  ClpPlusMinusOneMatrix(int numberRows, int numberColumns, bool columnOrdered,
                        const int *indices, const CoinBigIndex *startPositive,
                        const CoinBigIndex *startNegative);
  /** Subset constructor (without gaps).  Duplicates are allowed
         and order is as given */
  ClpPlusMinusOneMatrix(const ClpPlusMinusOneMatrix &wholeModel, int numberRows,
  ...
  void passInCopy(int numberRows, int numberColumns, bool columnOrdered,
                  int *indices, CoinBigIndex *startPositive,
...
class ClpPoolMatrix : public ClpMatrixBase {
 public:
  ...
  inline int getNumDifferentElements() const { return numberDifferent_; }
  /** Number of columns. */
  virtual int getNumCols() const { return numberColumns_; }
  /** Number of rows. */
  virtual int getNumRows() const { return numberRows_; }
  ...
  inline CoinBigIndex *columnStart() const { return columnStart_; }
  //@}
  ...
  /// Constructor from arrays
  ClpPoolMatrix(int numberRows, int numberColumns, const int *indices,
                const double *elements, const CoinBigIndex *columnStart);
  /// Constructor from arrays - handing over ownership
  ClpPoolMatrix(int numberColumns, CoinBigIndex *columnStart, poolInfo *stuff,
                double *elements);
  /** Subset constructor (without gaps).  Duplicates are allowed
         and order is as given */
  ClpPoolMatrix(const ClpPoolMatrix &wholeModel, int numberRows,
                const int *whichRows, int numberColumns,
                const int *whichColumns);
