...
class CglMixedIntegerRounding : public CglCutGenerator {
  ...
  */
  ...
  CglMixedIntegerRounding(const int maxaggr, const bool multiply,
 ...
 private:
  ...
  RowType determineRowType(const OsiSolverInterface& si, const int rowLen,
                           const int* ind, const double* coef, const char sense,
  ...
  void generateMirCuts(const OsiSolverInterface& si, const double* xlp,
                       ...
                       const double* coefByRow, const int* colInds,
                       ...
                       const CoinBigIndex* colStarts, const int* colLengths,
                       OsiCuts& cs) const;
  ...
  bool selectRowToAggregate(const OsiSolverInterface& si,
                            ...
                            const int* colLengths, int& rowSelected,
                            int& colSelected) const;

  // Aggregation heuristic.
  // Combines one or more rows of the original matrix
  void aggregateRow(const int colSelected, CoinPackedVector& rowToAggregate,
                    double rhs, CoinPackedVector& rowAggregated,
  ...
  bool cMirSeparation(
      ...
      const CoinPackedVector& rowAggregated, const int* listRowsAggregated,
      ...
      const double* colLowerBound, const CoinPackedVector& mixedKnapsack,
      const double& rhsMixedKnapsack, const CoinPackedVector& contVariablesInS,
  ...
  void cMirInequality(const int numInt, const double delta,
                      ...
                      const std::set<int>& setC, CoinPackedVector& cMIR,
