...
class OsiObject {
  ...
  */
  virtual double feasibleRegion(OsiSolverInterface *solver,
                                const OsiBranchingInformation *info) const = 0;
  ...
  */
   ...
   */
  virtual bool canDoHeuristics() const { return true; }
  /** \brief Return true if object can take part in move to nearest heuristic
   */
  virtual bool canMoveToNearest() const { return false; }
  ...
  */
  ...
  virtual bool canHandleShadowPrices() const { return false; }
  /// Return maximum number of ways branch may have
  inline int numberWays() const { return numberWays_; }
  ...
  */
  inline void setWhichWay(int way) { whichWay_ = static_cast<short int>(way); }
  /** Return current preferred way to branch.  If two
      then way=0 means down and 1 means up, otherwise
      way points to preferred branch
  */
  inline int whichWay() const { return whichWay_; }
  /// Get pre-emptive preferred way of branching - -1 off, 0 down, 1 up (for
  /// 2-way)
  virtual int preferredWay() const { return -1; }
  /// Return infeasibility
  inline double infeasibility() const { return infeasibility_; }
...
class OsiObject2 : public OsiObject {
 public:
  ...
  virtual int preferredWay() const { return preferredWay_; }
...
class OsiBranchingObject {
 public:
  ...
  inline int numberBranches() const { return numberBranches_; }
  ...
  inline void incrementNumberBranchesLeft() { numberBranches_++; }

  /** Set the number of branch arms left for this branching object
      Just for forcing
  */
  inline void setNumberBranchesLeft(
      int /*value*/) { /*assert (value==1&&!branchIndex_);*/
    numberBranches_ = 1;
  }

  /// Decrement the number of branch arms left for this branching object
  inline void decrementNumberBranchesLeft() { branchIndex_++; }
  ...
  */
  inline int branchIndex() const { return branchIndex_; }
  ...
  inline const OsiObject *originalObject() const { return originalObject_; }
...
class OsiBranchingInformation {
  ...
  */
  ...
  /// Dual to use if row bound violated (if negative then pseudoShadowPrices
  /// off)
  double defaultDual_;
  /// Pointer to solver
...
class OsiTwoWayBranchingObject : public OsiBranchingObject {
  ...
  */
  OsiTwoWayBranchingObject(OsiSolverInterface *solver,
                           const OsiObject *originalObject, int way,
                           double value);
...
class OsiSimpleInteger : public OsiObject2 {
  ...
  */
  ...
  inline void setColumnNumber(int value) { columnNumber_ = value; }
...
class OsiIntegerBranchingObject : public OsiTwoWayBranchingObject {
 public:
  ...
  /** Create a standard floor/ceiling branch object
    ...
    way = 1 for the up arm.
  */
  OsiIntegerBranchingObject(OsiSolverInterface *solver,
                            const OsiSimpleInteger *originalObject, int way,
                            double value);
  /** Create a standard floor/ceiling branch object
  ...
  */
  OsiIntegerBranchingObject(OsiSolverInterface *solver,
                            const OsiSimpleInteger *originalObject, int way,
                            double value, double downUpperBound,
                            double upLowerBound);
...
class OsiSOS : public OsiObject2 {
 public:
  ...
  /** Useful constructor - which are indices
      ...
      type is SOS type
  */
  OsiSOS(const OsiSolverInterface *solver, int numberMembers, const int *which,
         const double *weights, int type = 1);
  ...
  */
  ...
  /// SOS type
  inline int setType() const { return sosType_; }
  ...
  /// Return true if knows how to deal with Pseudo Shadow Prices
  virtual bool canHandleShadowPrices() const { return true; }
  /// Set number of members
  inline void setNumberMembers(int value) { numberMembers_ = value; }

  /// Members (indices in range 0 ... numberColumns-1)
  inline int *mutableMembers() const { return members_; }

  /// Set SOS type
  inline void setSosType(int value) { sosType_ = value; }
...
class OsiSOSBranchingObject : public OsiTwoWayBranchingObject {
 public:
  ...
  // Useful constructor
  OsiSOSBranchingObject(OsiSolverInterface *solver,
                        const OsiSOS *originalObject, int way,
                        double separator);
...
class OsiLotsize : public OsiObject2 {
  ...
  */
  OsiLotsize(const OsiSolverInterface *solver, int iColumn, int numberPoints,
...
class OsiLotsizeBranchingObject : public OsiTwoWayBranchingObject {
  ...
  */
  OsiLotsizeBranchingObject(OsiSolverInterface *solver,
                            const OsiLotsize *originalObject, int way,
                            double value);
