...
class ClpNetworkMatrix : public ClpMatrixBase {
 public:
  ...
  virtual CoinBigIndex getNumElements() const { return 2 * numberColumns_; }
  /** Number of columns. */
  ...
  inline bool trueNetwork() const { return trueNetwork_; }
  //@}
  ...
  ClpNetworkMatrix(const ClpNetworkMatrix &wholeModel, int numberRows,
