 ...
 */
class IpoptWarmStart : public virtual CoinWarmStartPrimalDual,
 ...
 public:
  ...
  IpoptWarmStart(int primal_size, int dual_size, const double *primal,
                 const double *dual);
  /// Copy constructor
  ...
  /// `Virtual constructor'
  virtual CoinWarmStart *clone() const { return new IpoptWarmStart(*this, 1); }
