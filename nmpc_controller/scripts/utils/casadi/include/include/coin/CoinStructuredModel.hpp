...
class CoinStructuredModel : public CoinBaseModel {
 public:
   ...
   */
  int addBlock(const std::string &rowBlock, const std::string &columnBlock,
 ...
 */
   ...
   */
  int addBlock(const std::string &rowBlock, const std::string &columnBlock,
               const CoinPackedMatrix &matrix, const double *rowLower,
               const double *rowUpper, const double *columnLower,
  ...
  */
  ...
  /// Read SMPS model
  int readSmps(const char *filename, bool keepNames = false,
  ...
  */
  ...
  /** Decompose a model specified as arrays + CoinPackedMatrix
      ...
      Returns number of blocks or zero if no structure
  */
  int decompose(const CoinPackedMatrix &matrix, const double *rowLower,
                const double *rowUpper, const double *columnLower,
                const double *columnUpper, const double *objective, int type,
                int maxBlocks = 50, int *starts = NULL,
  ...
  inline int numberRowBlocks() const { return numberRowBlocks_; }
  /// Return number of column blocks
  inline int numberColumnBlocks() const { return numberColumnBlocks_; }
  /// Return number of elementBlocks
  inline int numberElementBlocks() const { return numberElementBlocks_; }
  ...
  /// Return i'th block
  inline CoinBaseModel *block(int i) const { return blocks_[i]; }
  ...
  CoinModelBlockInfo block(int row, int column, const double *&rowLower,
                           const double *&rowUpper, const double *&columnLower,
