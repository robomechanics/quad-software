...
class OsiClpSolverInterface : virtual public OsiSolverInterface {
  ...
  */
  ...
  /// Get warmstarting information
  inline CoinWarmStartBasis *getPointerToWarmStart() { return &basis_; }
  /// Get warmstarting information
  ...
  */
  ...
  OsiRowCut *smallModelCut(const double *originalLower,
                           const double *originalUpper,
                           int numberRowsAtContinuous,
                           const int *whichGenerator, int typeCut = 0);
  ...
  */
  ...
  virtual int getNumCols() const { return modelPtr_->numberColumns(); }

  /// Get number of rows
  virtual int getNumRows() const { return modelPtr_->numberRows(); }
  ...
  /// maxLen is currently ignored and only there to match the signature from the
  /// base class!
  ...
  */
  ...
  /// Number of SOS sets
  inline int numberSOS() const { return numberSOS_; }
  /// SOS set info
  inline const CoinSet *setInfo() const { return setInfo_; }
  ...
  */
  ...
  virtual void loadProblem(const ClpMatrixBase &matrix, const double *collb,
                           const double *colub, const double *obj,
                           const double *rowlb, const double *rowub);
  ...
  */
  virtual int writeMpsNative(const char *filename, const char **rowNames,
                             const char **columnNames, int formatType = 0,
                             int numberAcross = 2, double objSense = 0.0) const;
  ...
  */
  ...
  /**
     ...
     The default behavior of this is do nothing so only use where that would not
     matter e.g. strengthening a matrix for MIP
  */
  ...
  */
  ...
  inline int lastAlgorithm() const { return lastAlgorithm_; }
  /// Set last algorithm used , 1 = primal, 2 = dual other unknown
  inline void setLastAlgorithm(int value) { lastAlgorithm_ = value; }
  /// Get scaling action option
  inline int cleanupScaling() const { return cleanupScaling_; }
  /** Set Scaling option
  ...
  */
  inline void setCleanupScaling(int value) { cleanupScaling_ = value; }
  /** Get smallest allowed element in cut.
      If smaller than this then ignored */
  inline double smallestElementInCut() const { return smallestElementInCut_; }
  ...
  */
  inline double smallestChangeInCut() const { return smallestChangeInCut_; }
  ...
  */
  ...
  /// Get fake objective
  ClpLinearObjective *fakeObjective() const { return fakeObjective_; }
 ...
 public:
  ...
  inline void setBasis() { setBasis(basis_, modelPtr_); }
  ...
  inline const double *upRange() const { return rowActivity_; }
  inline const double *downRange() const { return columnActivity_; }
  /// Pass in range array
  inline void passInRanges(int *array) { whichRange_ = array; }
  /// Pass in sos stuff from AMPl
  void setSOSData(int numberSOS, const char *type, const int *start,
                  const int *indices, const double *weights = NULL);
  ...
  inline double largestAway() const { return largestAway_; }
  /// Set largest amount continuous away from bound
  inline void setLargestAway(double value) { largestAway_ = value; }
  ...
  */
  ...
  /// SOS set info
  CoinSet *setInfo_;
  /// Alternate model (hot starts) - but also could be permanent and used for
  /// crunch
...
class OsiClpDisasterHandler : public ClpDisasterHandler {
 public:
  ...
  /// Get model
  inline OsiClpSolverInterface *osiModel() const { return osiModel_; }
  /// Set where from
  inline void setWhereFrom(int value) { whereFrom_ = value; }
  /// Get where from
  inline int whereFrom() const { return whereFrom_; }
  /// Set phase
  inline void setPhase(int value) { phase_ = value; }
  /// Get phase
