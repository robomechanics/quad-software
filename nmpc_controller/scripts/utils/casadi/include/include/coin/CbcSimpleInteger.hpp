...
class CbcIntegerBranchingObject : public CbcBranchingObject {
 public:
  ...
  inline const int *variables() const { return variables_; }
  // New bound
  inline const double *newBounds() const { return newBounds_; }
  ...
  inline bool active() const { return (down_[1] != -COIN_DBL_MAX); }
#endif

  /** Return the type (an integer identifier) of \c this */
  virtual CbcBranchObjType type() const { return SimpleIntegerBranchObj; }
...
class CbcSimpleInteger : public CbcObject {
 public:
  ...
  /*virtual*/ void fillCreateBranch(CbcIntegerBranchingObject *branching,
  ...
  /** Create an OsiSolverBranch object
    ...
    */
  virtual OsiSolverBranch *solverBranch(
      OsiSolverInterface *solver, const OsiBranchingInformation *info) const;
