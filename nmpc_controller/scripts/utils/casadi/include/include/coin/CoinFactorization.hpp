...
/** This deals with Factorization and Updates
    ...
    I was aiming at problems where I might get speed-up so I was looking at
   dense problems or ones with structure.  This led to permuting input and
   output vectors and to increasing the number of rows each rank-one update.
   This is still in as a minor overhead.
...
class CoinFactorization {
  ...
  */
  ...
  int factorize(int numberRows, int numberColumns, int numberElements,
                int maximumL, int maximumU, const int indicesRow[],
                const int indicesColumn[], const double elements[],
                int permutation[], double areaFactor = 0.0);
  ...
  int factorizePart1(int numberRows, int numberColumns,
                     int estimateNumberElements, int *indicesRow[],
                     int *indicesColumn[], CoinFactorizationDouble *elements[],
  ...
  inline int pivots() const { return numberPivots_; }
  /// Sets number of pivots since factorization
  inline void setPivots(int value) { numberPivots_ = value; }
  /// Returns address of permute region
  inline int *permute() const { return permute_.array(); }
  /// Returns address of pivotColumn region (also used for permuting)
  inline int *pivotColumn() const { return pivotColumn_.array(); }
  ...
  inline int *permuteBack() const { return permuteBack_.array(); }
  /// Returns address of lastRow region
  inline int *lastRow() const { return lastRow_.array(); }
  ...
  inline int *startRowL() const { return startRowL_.array(); }

  /// Start of each column in L
  inline int *startColumnL() const { return startColumnL_.array(); }

  /// Index of column in row for L
  inline int *indexColumnL() const { return indexColumnL_.array(); }

  /// Row indices of L
  inline int *indexRowL() const { return indexRowL_.array(); }
  ...
  inline int numberRowsExtra() const { return numberRowsExtra_; }
  /// Set number of Rows after factorization
  inline void setNumberRows(int value) { numberRows_ = value; }
  /// Number of Rows after factorization
  inline int numberRows() const { return numberRows_; }
  /// Number in L
  inline int numberL() const { return numberL_; }

  /// Base of L
  inline int baseL() const { return baseL_; }
  /// Maximum of Rows after iterating
  inline int maximumRowsExtra() const { return maximumRowsExtra_; }
  /// Total number of columns in factorization
  inline int numberColumns() const { return numberColumns_; }
  /// Total number of elements in factorization
  inline int numberElements() const { return totalElements_; }
  /// Length of FT vector
  inline int numberForrestTomlin() const {
    return numberInColumn_.array()[numberColumnsExtra_];
  }
  /// Number of good columns in factorization
  inline int numberGoodColumns() const { return numberGoodU_; }
  /// Whether larger areas needed
  inline double areaFactor() const { return areaFactor_; }
  inline void areaFactor(double value) { areaFactor_ = value; }
  /// Returns areaFactor but adjusted for dense
  double adjustedAreaFactor() const;
  /// Allows change of pivot accuracy check 1.0 == none >1.0 relaxed
  inline void relaxAccuracyCheck(double value) { relaxCheck_ = value; }
  inline double getAccuracyCheck() const { return relaxCheck_; }
  /// Level of detail of messages
  inline int messageLevel() const { return messageLevel_; }
  void messageLevel(int value);
  /// Maximum number of pivots between factorizations
  inline int maximumPivots() const { return maximumPivots_; }
  void maximumPivots(int value);

  /// Gets dense threshold
  inline int denseThreshold() const { return denseThreshold_; }
  /// Sets dense threshold
  inline void setDenseThreshold(int value) { denseThreshold_ = value; }
  /// Pivot tolerance
  inline double pivotTolerance() const { return pivotTolerance_; }
  void pivotTolerance(double value);
  /// Zero tolerance
  inline double zeroTolerance() const { return zeroTolerance_; }
  void zeroTolerance(double value);
#ifndef COIN_FAST_CODE
  /// Whether slack value is +1 or -1
  inline double slackValue() const { return slackValue_; }
  void slackValue(double value);
#endif
  /// Returns maximum absolute value in factorization
  double maximumCoefficient() const;
  /// true if Forrest Tomlin update, false if PFI
  inline bool forrestTomlin() const { return doForrestTomlin_; }
  inline void setForrestTomlin(bool value) { doForrestTomlin_ = value; }
  ...
  inline int numberDense() const { return numberDense_; }

  /// Returns number in U area
  inline int numberElementsU() const { return lengthU_; }
  /// Setss number in U area
  inline void setNumberElementsU(int value) { lengthU_ = value; }
  /// Returns length of U area
  inline int lengthAreaU() const { return lengthAreaU_; }
  /// Returns number in L area
  inline int numberElementsL() const { return lengthL_; }
  /// Returns length of L area
  inline int lengthAreaL() const { return lengthAreaL_; }
  /// Returns number in R area
  inline int numberElementsR() const { return lengthR_; }
  /// Number of compressions done
  inline int numberCompressions() const { return numberCompressions_; }
  /// Number of entries in each row
  inline int *numberInRow() const { return numberInRow_.array(); }
  /// Number of entries in each column
  inline int *numberInColumn() const { return numberInColumn_.array(); }
  /// Elements of U
  inline CoinFactorizationDouble *elementU() const { return elementU_.array(); }
  /// Row indices of U
  inline int *indexRowU() const { return indexRowU_.array(); }
  /// Start of each column in U
  inline int *startColumnU() const { return startColumnU_.array(); }
  /// Maximum number of Columns after iterating
  inline int maximumColumnsExtra() { return maximumColumnsExtra_; }
  /** L to U bias
      0 - U bias, 1 - some U bias, 2 some L bias, 3 L bias
  */
  inline int biasLU() const { return biasLU_; }
  inline void setBiasLU(int value) { biasLU_ = value; }
  ...
  */
  inline int persistenceFlag() const { return persistenceFlag_; }
  ...
  int replaceColumn(CoinIndexedVector *regionSparse, int pivotRow,
                    double pivotCheck, bool checkBeforeModifying = false,
                    double acceptablePivot = 1.0e-8);
  /** Combines BtranU and delete elements
      If deleted is NULL then delete elements
      otherwise store where elements are
  */
  void replaceColumnU(CoinIndexedVector *regionSparse, int *deleted,
  ...
  double checkReplacePart1(CoinIndexedVector *regionSparse,
                           CoinIndexedVector *partialUpdate, int pivotRow);
  /** Checks if can replace one Column in basis,
      returns 0=OK, 1=Probably OK, 2=singular, 3=no room, 5 max pivots */
  int checkReplacePart2(int pivotRow, double btranAlpha, double ftranAlpha,
                        double ftAlpha, double acceptablePivot = 1.0e-8);
  /** Replaces one Column to basis,
      partial update already in U */
  void replaceColumnPart3(CoinIndexedVector *regionSparse, int pivotRow,
                          double alpha);
  /** Replaces one Column to basis,
      partial update in vector */
  ...
  */
  ...
  void updateColumnFT(CoinIndexedVector &regionSparseFT,
                      CoinIndexedVector &partialUpdate, int which);
  /** Updates one column (FTRAN) long region */
  ...
  /** Updates one column (BTRAN) - long region */
  void updateColumnTransposeCpu(CoinIndexedVector &regionSparse,
                                int whichCpu) const;
  ...
  inline bool wantsTableauColumn() const { return false; }
  /// Pivot tolerance
  inline double minimumPivotTolerance() const { return pivotTolerance_; }
  inline void minimumPivotTolerance(double value) { pivotTolerance(value); }
  /// Says parallel
  inline void setParallelMode(int value) { parallelMode_ = value; }
  /// Sets solve mode
  ...
  /// Sets solve mode
  inline int solveMode() const { return parallelMode_ >> 2; }
  ...
  int replaceColumn2(CoinIndexedVector *regionSparse, int pivotRow,
                     double pivotCheck);
#endif
  //@}
  ...
  */
  ...
  void updateOneColumnTranspose(CoinIndexedVector *regionWork,
                                int &statistics) const;
  /** Updates two columns (BTRAN) from regionSparse2 and 3
      regionSparse starts as zero and is zero at end
      Note - if regionSparse2 packed on input - will be packed on output - same
     for 3
  */
  ...
  inline int sparseThreshold() const { return sparseThreshold_; }
  ...
  inline void clearArrays() { gutsOfDestructor(); }
  //@}
  ...
  int add(int numberElements, int indicesRow[], int indicesColumn[],
          double elements[]);
  ...
  int replaceRow(int whichRow, int numberElements, const int indicesColumn[],
...
#else
  inline bool collectStatistics() const { return true; }
  /// For statistics
  inline void setCollectStatistics(bool onOff) const {}
#endif
 ...
 protected:
  ...
  void updateTwoColumnsUDensish(int &numberNonZero1,
                                double *COIN_RESTRICT region1,
                                int *COIN_RESTRICT index1, int &numberNonZero2,
  ...
  */
  int replaceColumnPFI(CoinIndexedVector *regionSparse, int pivotRow,
                       double alpha);
...
#endif
  template <class T>
  inline bool pivot(int pivotRow, int pivotColumn, int pivotRowPosition,
                    int pivotColumnPosition, CoinFactorizationDouble work[],
                    unsigned int workArea2[], int increment2, T markRow[],
                    int largeInteger) {
    ...
    if (pivotColumnPosition < 0) {
      for (pivotColumnPosition = startRow; pivotColumnPosition < endRow;
           pivotColumnPosition++) {
    ...
    if (pivotRowPosition < 0) {
      for (pivotRowPosition = startColumn; pivotRowPosition < endColumn;
           pivotRowPosition++) {
    ...
    // zero out fill
    int iErase;
    for (iErase = 0; iErase < increment2 * numberInPivotRow; iErase++) {
      workArea2[iErase] = 0;
    }
...
#define FAC_UNSET (FAC_SET + 1)
{
  ...
  if (pivotColumnPosition < 0) {
    for (pivotColumnPosition = startRowThis; pivotColumnPosition < endRow;
         pivotColumnPosition++) {
  ...
  // **** HORRID coding coming up but a goto seems best!
  {
    ...
    if (pivotRowPosition < 0) {
      for (pivotRowPosition = startColumnThis; pivotRowPosition < endColumn;
           pivotRowPosition++) {
    ...
    // zero out fill
    int iErase;
    for (iErase = 0; iErase < increment2 * numberDoRow; iErase++) {
      workArea2[iErase] = 0;
    }
    ...
    for (jColumn = 0; jColumn < numberDoRow; jColumn++) {
      ...
      if (numberDoColumn > space) {
        ...
        // redo starts
        positionLargest =
            positionLargest + startColumn[iColumn] - startColumnThis;
