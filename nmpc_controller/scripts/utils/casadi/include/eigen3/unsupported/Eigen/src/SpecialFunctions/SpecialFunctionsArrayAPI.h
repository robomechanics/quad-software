...
EIGEN_STRONG_INLINE const Eigen::CwiseBinaryOp<
...
EIGEN_STRONG_INLINE const
    Eigen::CwiseBinaryOp<Eigen::internal::scalar_gamma_sample_der_alpha_op<
...
EIGEN_STRONG_INLINE const Eigen::CwiseTernaryOp<
