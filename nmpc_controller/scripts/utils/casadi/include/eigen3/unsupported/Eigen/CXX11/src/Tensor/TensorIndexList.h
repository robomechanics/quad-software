...
struct NumTraits<type2index<n>> {
  ...
  EIGEN_DEVICE_FUNC static EIGEN_CONSTEXPR EIGEN_STRONG_INLINE Real epsilon() {
    return 0;
  }
  EIGEN_DEVICE_FUNC static EIGEN_CONSTEXPR EIGEN_STRONG_INLINE Real
  dummy_precision() {
    return 0;
  }
  EIGEN_DEVICE_FUNC static EIGEN_CONSTEXPR EIGEN_STRONG_INLINE Real highest() {
    return n;
  }
  EIGEN_DEVICE_FUNC static EIGEN_CONSTEXPR EIGEN_STRONG_INLINE Real lowest() {
    return n;
  }
};
...
struct tuple_coeff {
  template <typename... T>
  EIGEN_DEVICE_FUNC static constexpr ValueT get(const Index i,
  ...
  template <typename... T>
  EIGEN_DEVICE_FUNC static void set(const Index i, IndexTuple<T...>& t,
                                    const ValueT& value) {
    if (i == Idx) {
  ...
  EIGEN_DEVICE_FUNC static constexpr bool value_known_statically(
      const Index i, const IndexTuple<T...>& t) {
    return ((i == Idx) &
...
struct tuple_coeff<0, ValueT> {
  ...
  template <typename... T>
  EIGEN_DEVICE_FUNC static constexpr bool value_known_statically(
      const Index i, const IndexTuple<T...>&) {
    return is_compile_time_constant<
...
struct IndexList : internal::IndexTuple<FirstType, OtherTypes...> {
  EIGEN_STRONG_INLINE EIGEN_DEVICE_FUNC constexpr Index operator[](
      const Index i) const {
  ...
  EIGEN_STRONG_INLINE EIGEN_DEVICE_FUNC constexpr Index get(
      const Index i) const {
    return internal::tuple_coeff<internal::array_size<internal::IndexTuple<
                                     FirstType, OtherTypes...>>::value -
                                     1,
  ...
  EIGEN_STRONG_INLINE EIGEN_DEVICE_FUNC void set(const Index i,
                                                 const Index value) {
    return internal::tuple_coeff<internal::array_size<internal::IndexTuple<
                                     FirstType, OtherTypes...>>::value -
                                     1,
...
struct IndexPairList : internal::IndexTuple<FirstType, OtherTypes...> {
  EIGEN_STRONG_INLINE EIGEN_DEVICE_FUNC constexpr IndexPair<Index> operator[](
      const Index i) const {
    return internal::tuple_coeff<internal::array_size<internal::IndexTuple<
                                     FirstType, OtherTypes...>>::value -
                                     1,
...
array_prod(const IndexList<FirstType, OtherTypes...>& sizes) {
  Index result = 1;
  EIGEN_UNROLL_LOOP
  for (size_t i = 0; i < array_size<IndexList<FirstType, OtherTypes...>>::value;
       ++i) {
    result *= sizes[i];
  }
  return result;
...
EIGEN_DEVICE_FUNC constexpr Index array_get(
...
template <typename T>
static EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR bool index_statically_eq(Index i,
                                                                  Index value) {
  return index_statically_eq_impl<T>::run(i, value);
}

template <typename T>
static EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR bool index_statically_ne(Index i,
                                                                  Index value) {
  return index_statically_ne_impl<T>::run(i, value);
}

template <typename T>
static EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR bool index_statically_gt(Index i,
                                                                  Index value) {
  return index_statically_gt_impl<T>::run(i, value);
}

template <typename T>
static EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR bool index_statically_lt(Index i,
                                                                  Index value) {
