...
template <typename Index, std::ptrdiff_t NumIndices, std::ptrdiff_t n,
          bool RowMajor>
...
struct fixed_size_tensor_index_extraction_helper {
  template <typename Dimensions>
  EIGEN_DEVICE_FUNC static EIGEN_STRONG_INLINE Index
  run(const Index index, const Dimensions& dimensions) {
...
struct Sizes {
  ...
  template <typename DenseIndex>
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE ptrdiff_t
...
template <std::ptrdiff_t V1 = 0, std::ptrdiff_t V2 = 0, std::ptrdiff_t V3 = 0,
          std::ptrdiff_t V4 = 0, std::ptrdiff_t V5 = 0>
struct Sizes {
...
namespace internal {
template <std::ptrdiff_t V1, std::ptrdiff_t V2, std::ptrdiff_t V3,
          std::ptrdiff_t V4, std::ptrdiff_t V5>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE std::ptrdiff_t array_prod(
...
struct DSizes : array<DenseIndex, NumDims> {
  ...
  EIGEN_DEVICE_FUNC explicit DSizes(
      ...
      typename internal::enable_if<
          internal::is_same<DenseIndex,
                            typename internal::promote_index_type<
                                DenseIndex, OtherIndex>::type>::value,
          void*>::type = 0) {
    for (int i = 0; i < NumDims; ++i) {
...
template <std::ptrdiff_t n, std::ptrdiff_t V1, std::ptrdiff_t V2,
          std::ptrdiff_t V3, std::ptrdiff_t V4, std::ptrdiff_t V5>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE std::ptrdiff_t array_get(
    const Sizes<V1, V2, V3, V4, V5>&) {
...
struct sizes_match_below_dim<Dims1, Dims2, n, n> {
  static EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE bool run(Dims1& dims1,
                                                        Dims2& dims2) {
...
template <typename Dims1, typename Dims2>
EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE bool dimensions_match(Dims1 dims1,
                                                            Dims2 dims2) {
