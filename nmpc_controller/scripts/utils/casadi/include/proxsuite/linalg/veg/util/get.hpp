...
VEG_DEF_CONCEPT((usize I, typename T), member_gettable,
                VEG_CONCEPT(detected<_detail::_meta::member_get_expr,
                                     meta::constant<usize, I>, T>));
VEG_DEF_CONCEPT((usize I, typename T), adl_gettable,
                VEG_CONCEPT(detected<_detail::_meta::adl_get_expr,
                                     meta::constant<usize, I>, T>));

VEG_DEF_CONCEPT_DISJUNCTION((usize I, typename T), gettable,
                            ((, array_gettable<I, T>),
                             (, member_gettable<I, T>),
                             (, adl_gettable<I, T>)));
}  // namespace concepts
...
struct get {
  VEG_TEMPLATE(
      ...
      VEG_INLINE constexpr auto operator(), (arg, T &&))
  const VEG_NOEXCEPT_IF(VEG_IS_NOEXCEPT(Impl::template apply<I>(VEG_FWD(arg))))
      ->meta::detected_t<Impl::template result_type, meta::constant<usize, I>,
                         T> {
