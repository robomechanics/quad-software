...
struct DenseVecRef {
  DenseVecRef() = default;
  DenseVecRef(FromRawParts /*from_raw_parts*/, T const* data,
              isize len) noexcept
      : _{data, len} {}
  template <typename V>
...
struct VecRef {
  VecRef(  //
      FromRawParts /*from_raw_parts*/, isize nrows, isize nnz,
      I const* row_indices, T const* values)
...
struct SymbolicMatRef : _detail::SymbolicMatRefInterface<SymbolicMatRef<I>, I> {
  ...
  SymbolicMatRef(FromRawParts /*from_raw_parts*/, isize nrows, isize ncols,
                 isize nnz, I const* col_ptrs, I const* nnz_per_col,
                 I const* row_indices)
      : _{
...
struct SymbolicMatMut : _detail::SymbolicMatMutInterface<SymbolicMatMut<I>, I> {
  ...
  SymbolicMatMut(FromRawParts /*from_raw_parts*/, isize nrows, isize ncols,
                 isize nnz, I* col_ptrs, I* nnz_per_col, I* row_indices)
      : _{
            nrows, ncols, nnz, col_ptrs, nnz_per_col, row_indices,
        } {}
...
struct MatRef : _detail::SymbolicMatRefInterface<MatRef<T, I>, I> {
  ...
  MatRef(FromRawParts /*from_raw_parts*/, isize nrows, isize ncols, isize nnz,
         I const* col_ptrs, I const* nnz_per_col, I const* row_indices,
         T const* values)
      : _{
...
struct MatMut : _detail::SymbolicMatMutInterface<MatMut<T, I>, I> {
  ...
  MatMut(FromRawParts /*from_raw_parts*/, isize nrows, isize ncols, isize nnz,
         I* col_ptrs, I* nnz_per_col, I* row_indices, T* values)
      : _{
            nrows, ncols, nnz, col_ptrs, nnz_per_col, row_indices, values,
        } {}
