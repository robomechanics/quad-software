...
void serialize(Archive& archive, proxsuite::proxqp::Settings<T>& settings) {
  archive(
      CEREAL_NVP(settings.default_rho), CEREAL_NVP(settings.default_mu_eq),
      CEREAL_NVP(settings.default_mu_in), CEREAL_NVP(settings.alpha_bcl),
      ...
      CEREAL_NVP(settings.mu_min_eq), CEREAL_NVP(settings.mu_min_in),
      CEREAL_NVP(settings.mu_max_eq_inv), CEREAL_NVP(settings.mu_update_factor),
      ...
      CEREAL_NVP(settings.cold_reset_mu_in_inv), CEREAL_NVP(settings.eps_abs),
      CEREAL_NVP(settings.eps_rel), CEREAL_NVP(settings.max_iter),
      CEREAL_NVP(settings.max_iter_in), CEREAL_NVP(settings.safe_guard),
      CEREAL_NVP(settings.nb_iterative_refinement),
      CEREAL_NVP(settings.eps_refact), CEREAL_NVP(settings.verbose),
      ...
      CEREAL_NVP(settings.eps_primal_inf), CEREAL_NVP(settings.eps_dual_inf),
      CEREAL_NVP(settings.bcl_update), CEREAL_NVP(settings.sparse_backend));
}
}  // namespace cereal
