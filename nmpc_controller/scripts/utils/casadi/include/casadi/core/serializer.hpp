...
class CASADI_EXPORT SerializerBase {
 ...
 public:
#ifndef SWIG
  SerializerBase(std::unique_ptr<std::ostream> stream,
...
class CASADI_EXPORT StringSerializer : public SerializerBase {
 public:
   ...
   *  You are encouraged to use the vector/list variants of 'save' for SX/MX to
   reduce
   *  the overhead.
   *
   *
   * \see Function::save, Function::serialize, StringDeserializer,
   FileSerializer
   *
      \identifier{7o} */
