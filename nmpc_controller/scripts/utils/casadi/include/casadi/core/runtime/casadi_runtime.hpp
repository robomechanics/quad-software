...
/// SWAP: x <-> y
template <typename T1>
void casadi_swap(casadi_int n, T1* x, casadi_int inc_x, T1* y,
                 casadi_int inc_y);

/// Sparse copy: y <- x, w work vector (length >= number of rows)
template <typename T1>
void casadi_project(const T1* x, const casadi_int* sp_x, T1* y,
...
template <typename T1>
void casadi_mtimes(const T1* x, const casadi_int* sp_x, const T1* y,
                   const casadi_int* sp_y, T1* z, const casadi_int* sp_z, T1* w,
                   casadi_int tr);

/// Sparse matrix-vector multiplication: z <- z + x*y
template <typename T1>
void casadi_mv(const T1* x, const casadi_int* sp_x, const T1* y, T1* z,
               casadi_int tr);

/// Linear solve, upper triangular matrix, optionally transposed or unity
/// diagonal (1 - R)
template <typename T1>
void casadi_triusolve(const casadi_int* sp_a, const T1* nz_a, T1* x, int tr,
                      int unity, casadi_int nrhs);

/// Linear solve, lower triangular matrix, optionally transposed or unity
/// diagonal (1 - L)
template <typename T1>
void casadi_trilsolve(const casadi_int* sp_a, const T1* nz_a, T1* x, int tr,
                      int unity, casadi_int nrhs);
 ...
 */
template <typename T1>
T1 casadi_norm_inf_mul(const T1* x, const casadi_int* sp_x, const T1* y,
...
template <typename T1>
void casadi_kron(const T1* a, const casadi_int* sp_a, const T1* b,
...
template <typename T1>
casadi_int casadi_low(T1 x, const T1* grid, casadi_int ng,
                      casadi_int lookup_mode);

// Get weights for the multilinear interpolant
template <typename T1>
void casadi_interpn_weights(casadi_int ndim, const T1* grid,
                            const casadi_int* offset, const T1* x, T1* alpha,
                            casadi_int* index);

// Get coefficients for the multilinear interpolant
template <typename T1>
T1 casadi_interpn_interpolate(casadi_int ndim, const casadi_int* offset,
                              const T1* values, const T1* alpha,
                              const casadi_int* index, const casadi_int* corner,
                              T1* coeff);

// Multilinear interpolant
template <typename T1>
T1 casadi_interpn(casadi_int ndim, const T1* grid, const casadi_int* offset,
                  const T1* values, const T1* x, casadi_int* iw, T1* w);

// Multilinear interpolant - calculate gradient
template <typename T1>
void casadi_interpn_grad(T1* grad, casadi_int ndim, const T1* grid,
                         const casadi_int* offset, const T1* values,
                         const T1* x, casadi_int* iw, T1* w);

// De boor single basis evaluation
template <typename T1>
void casadi_de_boor(T1 x, const T1* knots, casadi_int n_knots,
                    casadi_int degree, T1* boor);

// De boor nd evaluation
template <typename T1>
void casadi_nd_boor_eval(T1* ret, casadi_int n_dims, const T1* knots,
                         const casadi_int* offset, const casadi_int* degree,
                         const casadi_int* strides, const T1* c, casadi_int m,
                         const T1* x, const casadi_int* lookup_mode,
                         casadi_int* iw, T1* w);
...
// Alias names
inline void casadi_fill_casadi_int(casadi_int* x, casadi_int n,
                                   casadi_int alpha) {
...
template <typename T1>
void casadi_bound_consistency(casadi_int n, T1* x, T1* lam, const T1* lbx,
                              const T1* ubx);
