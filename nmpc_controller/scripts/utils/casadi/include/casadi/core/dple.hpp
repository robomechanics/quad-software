 ...
 */
///@{
CASADI_EXPORT Function dplesol(const std::string& name,
                               const std::string& solver, const SpDict& st,
                               const Dict& opts = Dict());
CASADI_EXPORT MX dplesol(const MX& A, const MX& V, const std::string& solver,
                         const Dict& opts = Dict());
CASADI_EXPORT MXVector dplesol(const MXVector& A, const MXVector& V,
                               const std::string& solver,
                               const Dict& opts = Dict());
CASADI_EXPORT DMVector dplesol(const DMVector& A, const DMVector& V,
                               const std::string& solver,
                               const Dict& opts = Dict());
///@}
...
enum DpleOutput {
  /// Lyapunov matrix (horzcat when const_dim, diagcat otherwise) (Cholesky of P
  /// if pos_def) [p]
  DPLE_P,
  /// Number of arguments.
  DPLE_NUM_OUT
