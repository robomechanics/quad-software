...
class GenericExpression : public GenericExpressionCommon {
 protected:
  // Helper functions
  inline const ExType& self() const {
  ...
  */
   ...
   * expression is zero and 0 otherwise
      ...
      \identifier{oz} */
  static ExType logic_not(const ExType& x) { return ExType::unary(OP_NOT, x); }
  friend inline ExType logic_not(const ExType& x) {
    return ExType::logic_not(x);
  }
  inline ExType operator!() const { return logic_not(self()); }
  ///@}
  ...
  /** \brief Absolute value: x -> abs(x)
      ...
      \identifier{p0} */
  static ExType abs(const ExType& x) { return ExType::unary(OP_FABS, x); }
  friend inline ExType abs(const ExType& x) { return ExType::abs(x); }
  friend inline ExType fabs(const ExType& x) { return abs(x); }
  ///@}
  ...
  /** \brief Square root: x -> sqrt(x)
      ...
      \identifier{p1} */
  static ExType sqrt(const ExType& x) { return ExType::unary(OP_SQRT, x); }
  friend inline ExType sqrt(const ExType& x) { return ExType::sqrt(x); }
  ///@}
  ...
  /** \brief Square: x -> x^2
      ...
      \identifier{p2} */
  static ExType sq(const ExType& x) { return ExType::unary(OP_SQ, x); }
  friend inline ExType sq(const ExType& x) { return ExType::sq(x); }
  ///@}
  ...
  /** \brief Sine: x -> sin(x)
      ...
      \identifier{p3} */
  static ExType sin(const ExType& x) { return ExType::unary(OP_SIN, x); }
  friend inline ExType sin(const ExType& x) { return ExType::sin(x); }
  ///@}
  ...
  /** \brief Cosine: x -> cos(x)
      ...
      \identifier{p4} */
  static ExType cos(const ExType& x) { return ExType::unary(OP_COS, x); }
  friend inline ExType cos(const ExType& x) { return ExType::cos(x); }
  ///@}
  ...
  /** \brief Tangent: x -> tan(x)
      ...
      \identifier{p5} */
  static ExType tan(const ExType& x) { return ExType::unary(OP_TAN, x); }
  friend inline ExType tan(const ExType& x) { return ExType::tan(x); }
  ///@}
  ...
  /** \brief Arc tangent: x -> atan(x)
      ...
      \identifier{p6} */
  static ExType atan(const ExType& x) { return ExType::unary(OP_ATAN, x); }
  friend inline ExType atan(const ExType& x) { return ExType::atan(x); }
  ///@}
  ...
  /** \brief Arc sine: x -> asin(x)
      ...
      \identifier{p7} */
  static ExType asin(const ExType& x) { return ExType::unary(OP_ASIN, x); }
  friend inline ExType asin(const ExType& x) { return ExType::asin(x); }
  ///@}
  ...
  /** \brief Arc cosine: x -> acos(x)
      ...
      \identifier{p8} */
  static ExType acos(const ExType& x) { return ExType::unary(OP_ACOS, x); }
  friend inline ExType acos(const ExType& x) { return ExType::acos(x); }
  ///@}
  ...
  /** \brief Hyperbolic tangent: x -> tanh(x)
      ...
      \identifier{p9} */
  static ExType tanh(const ExType& x) { return ExType::unary(OP_TANH, x); }
  friend inline ExType tanh(const ExType& x) { return ExType::tanh(x); }
  ///@}
  ...
  /** \brief Hyperbolic sin: x -> sinh(x)
      ...
      \identifier{pa} */
  static ExType sinh(const ExType& x) { return ExType::unary(OP_SINH, x); }
  friend inline ExType sinh(const ExType& x) { return ExType::sinh(x); }
  ///@}
  ...
  /** \brief Hyperbolic cosine: x -> cosh(x)
      ...
      \identifier{pb} */
  static ExType cosh(const ExType& x) { return ExType::unary(OP_COSH, x); }
  friend inline ExType cosh(const ExType& x) { return ExType::cosh(x); }
  ///@}
  ...
  /** \brief Inverse hyperbolic tangent: x -> atanh(x)
      ...
      \identifier{pc} */
  static ExType atanh(const ExType& x) { return ExType::unary(OP_ATANH, x); }
  friend inline ExType atanh(const ExType& x) { return ExType::atanh(x); }
  ///@}
  ...
  /** \brief Inverse hyperbolic sin: x -> asinh(x)
      ...
      \identifier{pd} */
  static ExType asinh(const ExType& x) { return ExType::unary(OP_ASINH, x); }
  friend inline ExType asinh(const ExType& x) { return ExType::asinh(x); }
  ///@}
  ...
  /** \brief Inverse hyperbolic cosine: x -> acosh(x)
      ...
      \identifier{pe} */
  static ExType acosh(const ExType& x) { return ExType::unary(OP_ACOSH, x); }
  friend inline ExType acosh(const ExType& x) { return ExType::acosh(x); }
  ///@}
  ...
  /** \brief Elementwise exponential: x -> exp(x)
      ...
      \identifier{pf} */
  static ExType exp(const ExType& x) { return ExType::unary(OP_EXP, x); }
  friend inline ExType exp(const ExType& x) { return ExType::exp(x); }
  ///@}
  ...
  /** \brief Natural logarithm: x -> log(x)
      ...
      \identifier{pg} */
  static ExType log(const ExType& x) { return ExType::unary(OP_LOG, x); }
  friend inline ExType log(const ExType& x) { return ExType::log(x); }
  ///@}
  ...
  /** \brief Base-10 logarithm: x -> log10(x)
      ...
      \identifier{ph} */
  static ExType log10(const ExType& x) { return log(x) * (1 / std::log(10.)); }
  friend inline ExType log10(const ExType& x) { return ExType::log10(x); }
  ///@}
  ...
  /** \brief Precision variant for natural logarithm: x -> log(x+1)
      ...
      \identifier{pi} */
  static ExType log1p(const ExType& x) { return ExType::unary(OP_LOG1P, x); }
  friend inline ExType log1p(const ExType& x) { return ExType::log1p(x); }
  ///@}
  ...
  /** \brief Precision variant for elementwise exponential: x -> exp(x)-1
      ...
      \identifier{pj} */
  static ExType expm1(const ExType& x) { return ExType::unary(OP_EXPM1, x); }
  friend inline ExType expm1(const ExType& x) { return ExType::expm1(x); }
  ///@}
  ...
  /** \brief Round down to nearest integer: x -> floor(x)
      ...
      \identifier{pk} */
  static ExType floor(const ExType& x) { return ExType::unary(OP_FLOOR, x); }
  friend inline ExType floor(const ExType& x) { return ExType::floor(x); }
  ///@}
  ...
  /** \brief Round up to nearest integer: x -> ceil(x)
      ...
      \identifier{pl} */
  static ExType ceil(const ExType& x) { return ExType::unary(OP_CEIL, x); }
  friend inline ExType ceil(const ExType& x) { return ExType::ceil(x); }
  ///@}
  ...
  /** \brief Error function: x -> erf(x)
      ...
      \identifier{pm} */
  static ExType erf(const ExType& x) { return ExType::unary(OP_ERF, x); }
  friend inline ExType erf(const ExType& x) { return ExType::erf(x); }
  ///@}
  ...
  /** \brief Inverse error function: x -> erfinv(x)
      ...
      \identifier{pn} */
  static ExType erfinv(const ExType& x) { return ExType::unary(OP_ERFINV, x); }
  friend inline ExType erfinv(const ExType& x) { return ExType::erfinv(x); }
  ///@}
  ...
  /** \brief Sign function:
      ...
      \identifier{po} */
  static ExType sign(const ExType& x) { return ExType::unary(OP_SIGN, x); }
  friend inline ExType sign(const ExType& x) { return ExType::sign(x); }
  ///@}
  ...
  This is equivalent to Python's math.remainder. There is no equivalence in
  Matlab.
   ...
   * Depth=0 checks if the expressions are identical, i.e. points to the same
   node.
   *
   * a = x*x
   * b = x*x
   ...
   *  is_equal(a,b,0)  will return false, but a.is_equal(a,b,1) will return true
      ...
      \identifier{pv} */
  friend inline bool is_equal(const ExType& x, const ExType& y,
                              casadi_int depth = 0) {
