...
template <>
inline std::string matrixName<SXElem>() {
  return "SX";
}
...
template <>
bool SX::has_duplicates() const;

template <>
void SX::reset_input() const;
...
template <>
SX SX::gauss_quadrature(const SX& f, const SX& x, const SX& a, const SX& b,
                        casadi_int order, const SX& w);

template <>
SX SX::simplify(const SX& x);

template <>
std::vector<SX> SX::substitute(const std::vector<SX>& ex,
...
template <>
std::vector<std::vector<SX> > SX::forward(
    const std::vector<SX>& ex, const std::vector<SX>& arg,
    const std::vector<std::vector<SX> >& v, const Dict& opts);

template <>
std::vector<std::vector<SX> > SX::reverse(
    const std::vector<SX>& ex, const std::vector<SX>& arg,
    const std::vector<std::vector<SX> >& v, const Dict& opts);

template <>
std::vector<bool> SX::which_depends(const SX& expr, const SX& var,
...
template <>
SX SX::taylor(const SX& f, const SX& x, const SX& a, casadi_int order);
...
template <>
std::string SX::print_operator(const SX& X,
...
template <>
void SX::shared(std::vector<SX>& ex, std::vector<SX>& v_sx,
                std::vector<SX>& vdef_sx, const std::string& v_prefix,
...
template <>
void SX::print_split(casadi_int nnz, const SXElem* nonzeros,
                     std::vector<std::string>& nz,
                     std::vector<std::string>& inter);

template <>
std::vector<SX> SX::get_input(const Function& f);
template <>
std::vector<SX> SX::get_free(const Function& f);
template <>
