...
class CASADI_EXPORT CodeGenerator {
 public:
  ...
  /** \brief Get or add a constant
      ...
      \identifier{rx} */
  casadi_int get_constant(const std::vector<double>& v,
                          bool allow_adding = false);

  /** \brief Get or add an integer constant

      \identifier{ry} */
  casadi_int get_constant(const std::vector<casadi_int>& v,
                          bool allow_adding = false);
  ...
  /** \brief Represent an array constant; adding it when new
      ...
      \identifier{s0} */
  void constant_copy(const std::string& var_name,
  ...
  /** \brief Declare a local variable
      ...
      \identifier{sb} */
  void local(const std::string& name, const std::string& type,
  ...
  /** \brief Codegen axpy: y += a*x
      ...
      \identifier{sp} */
  std::string axpy(casadi_int n, const std::string& a, const std::string& x,
                   const std::string& y);
  ...
  /** \brief What does scal do??
      ...
      \identifier{sq} */
  std::string scal(casadi_int n, const std::string& alpha,
                   const std::string& x);
  ...
  /** \brief Codegen lower triangular solve
      ...
      \identifier{ss} */
  std::string trilsolve(const Sparsity& sp_x, const std::string& x,
                        const std::string& y, bool tr, bool unity,
                        casadi_int nrhs);

  /** \brief Codegen upper triangular solve

      \identifier{st} */
  std::string triusolve(const Sparsity& sp_x, const std::string& x,
                        const std::string& y, bool tr, bool unity,
                        casadi_int nrhs);
  ...
  /** \brief Rank-1 update
      ...
      \identifier{sv} */
  std::string rank1(const std::string& A, const Sparsity& sp_A,
  ...
  /** \brief Multilinear interpolation
      ...
      \identifier{sw} */
  std::string interpn(const std::string& res, casadi_int ndim,
                      const std::string& grid, const std::string& offset,
  ...
  /** \brief Multilinear interpolation - calculate gradient
      ...
      \identifier{sx} */
  std::string interpn_grad(const std::string& grad, casadi_int ndim,
                           const std::string& grid, const std::string& offset,
                           const std::string& values, const std::string& x,
                           const std::string& lookup_mode, casadi_int m,
                           const std::string& iw, const std::string& w);
  ...
  std::string lsqr_solve(const std::string& A, const std::string& x,
                         casadi_int nrhs, bool tr, const std::string& sp,
                         const std::string& w);
  ...
  /** \brief vfmax
      ...
      \identifier{ta} */
  std::string vfmax(const std::string& x, const std::string& n,
                    const std::string& y);

  /** \brief vfmin

      \identifier{tb} */
  std::string vfmin(const std::string& x, const std::string& n,
                    const std::string& y);
  ...
  std::string bound_consistency(casadi_int n, const std::string& x,
                                const std::string& lam, const std::string& lbx,
  ...
  /** \brief regularize
      ...
      \identifier{tj} */
  std::string regularize(const Sparsity& sp_h, const std::string& h,
                         const std::string& reg);

  /** \brief convexify

      \identifier{tk} */
  std::string convexify_eval(const ConvexifyData& d, const std::string& Hin,
                             const std::string& Hout, const std::string& iw,
                             const std::string& w);

  /** \brief low

      \identifier{tl} */
  std::string low(const std::string& x, const std::string& grid, casadi_int ng,
  ...
  /** \brief Add a built-in auxiliary function
      ...
      \identifier{tp} */
  void add_auxiliary(Auxiliary f,
  ...
  /** \brief Create a copy operation
      ...
      \identifier{tt} */
  std::string copy(const std::string& arg, std::size_t n,
                   const std::string& res);
  void copy_check(const std::string& arg, std::size_t n, const std::string& res,
                  bool check_lhs = true, bool check_rhs = true);
  void copy_default(const std::string& arg, std::size_t n,
                    const std::string& res, const std::string& def,
                    bool check_rhs = true);
  ...
  /** \brief Get matrix from MATLAB's MEX format
      ...
      \identifier{u4} */
  std::string from_mex(std::string& arg, const std::string& res,
                       std::size_t res_off, const Sparsity& sp_res,
                       const std::string& w);
  ...
  /** \brief Slurp a file
      ...
      \identifier{u7} */
  std::string file_slurp(const std::string& fname, casadi_int n,
                         const std::string& a);
  ...
  std::string cache_check(const std::string& key, const std::string& cache,
                          const std::string& loc, casadi_int stride,
                          casadi_int sz, casadi_int key_sz,
 ...
 private:
  ...
  void generate_sfunction(const std::string& name,
