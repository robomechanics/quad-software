...
extern "C" int eval_g_leg_simple_to_complex_checkout(void);
extern "C" void eval_g_leg_simple_to_complex_release(int mem);
extern "C" void eval_g_leg_simple_to_complex_incref(void);
extern "C" void eval_g_leg_simple_to_complex_decref(void);
extern "C" casadi_int eval_g_leg_simple_to_complex_n_out(void);
extern "C" casadi_int eval_g_leg_simple_to_complex_n_in(void);
