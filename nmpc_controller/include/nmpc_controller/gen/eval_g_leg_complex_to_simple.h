...
extern "C" int eval_g_leg_complex_to_simple(const casadi_real** arg,
...
extern "C" const casadi_int* eval_g_leg_complex_to_simple_sparsity_in(
    casadi_int i);
extern "C" const casadi_int* eval_g_leg_complex_to_simple_sparsity_out(
    casadi_int i);
extern "C" int eval_g_leg_complex_to_simple_work(casadi_int* sz_arg,
                                                 casadi_int* sz_res,
                                                 casadi_int* sz_iw,
                                                 casadi_int* sz_w);
